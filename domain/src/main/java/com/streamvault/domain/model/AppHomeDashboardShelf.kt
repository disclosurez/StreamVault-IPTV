...
enum class AppHomeDashboardShelf(
    ...
    PINNED_CATEGORIES("pinned_categories", defaultEnabled = true),
    TRENDING_MOVIES("trending_movies", defaultEnabled = true),
    TRENDING_SERIES("trending_series", defaultEnabled = true),
