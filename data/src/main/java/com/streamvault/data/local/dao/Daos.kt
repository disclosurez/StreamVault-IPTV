...
interface MovieDao {
    ...
    @Query("SELECT * FROM movies WHERE provider_id = :providerId AND added_at > 0 ORDER BY added_at DESC, year DESC, name ASC, id ASC LIMIT :limit")
    ...
    fun getFreshCountByProvider(providerId: Long): Flow<Int>
        ...
        @Query("SELECT * FROM movies WHERE provider_id = :providerId ORDER BY added_at DESC, year DESC, name ASC, id ASC LIMIT :limit")
    ...
    @Query(
        ...
        ORDER BY added_at DESC, year DESC, name ASC, id ASC
        LIMIT :limit
        """
    )
    ...
    @Query("SELECT * FROM movies WHERE provider_id = :providerId AND category_id = :categoryId AND added_at > 0 ORDER BY added_at DESC, year DESC, name ASC, id ASC LIMIT :limit")
    ...
    fun getFreshCountByCategory(providerId: Long, categoryId: Long): Flow<Int>
        ...
        @Query("SELECT * FROM movies WHERE provider_id = :providerId AND category_id = :categoryId ORDER BY added_at DESC, year DESC, name ASC, id ASC LIMIT :limit")
